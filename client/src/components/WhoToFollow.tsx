      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between border-2 border-neutral-700 rounded-md gap-2 p-2 ">
          <div className="flex gap-2">
            ...
            <div>
              <GenerateAvatar
                userAddress={"0x2342373992d054eF318081c111cF4C87B44aBa869"}
                size={40}
              />
            </div>
        ...
        <div className="flex items-center justify-between border-2 border-neutral-700 rounded-md gap-2 p-2 ">
          <div className="flex gap-2">
            <div>
              <GenerateAvatar
                userAddress={"0x86786773992d054eF318081c111cF4C87B44aBa869"}
                size={40}
              />
            </div>
            <div className="flex-1">
        ...
        <div className="flex items-center justify-between border-2 border-neutral-700 rounded-md gap-2 p-2 ">
          <div className="flex gap-2">
            <div>
              <GenerateAvatar
                userAddress={"0x652373992d054eF318081c111cF4C87B44aBa869"}
                size={40}
              />
            </div>
            <div className="flex-1">
